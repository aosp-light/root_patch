...
import com.android.emusic.MusicUtils.ServiceToken;
        ...
        try {
            switch (mService.getRepeatMode()) {
                case MediaPlaybackService.REPEAT_ALL:
                    mRepeatButton.setImageResource(R.drawable.music_playview_repeat_all_selector);
                    break;
                case MediaPlaybackService.REPEAT_CURRENT:
                    mRepeatButton.setImageResource(R.drawable.music_playview_repeat_one_selector);
                    break;
                default:
                    mRepeatButton.setImageResource(R.drawable.music_playview_repeat_off_selector);
                    break;
            }
        } catch (RemoteException ex) {
        }
        ...
        try {
            switch (mService.getShuffleMode()) {
                case MediaPlaybackService.SHUFFLE_NONE:
                    mShuffleButton.setImageResource(R.drawable.music_playview_shuffle_off_selector);
                    break;
                case MediaPlaybackService.SHUFFLE_AUTO:
                    mShuffleButton.setImageResource(R.drawable.music_playview_shuffle_on_selector);
                    break;
                default:
                    mShuffleButton.setImageResource(R.drawable.music_playview_shuffle_on_selector);
                    break;
    ...
    private void setPauseButtonImage() {
        try {
            if (mService != null && mService.isPlaying()) {
                mPauseButton.setImageResource(R.drawable.aic_pause_white_48dp);
            } else {
                mPauseButton.setImageResource(R.drawable.aic_play_arrow_white_48dp);
            }
        } catch (RemoteException ex) {
        }
    }
