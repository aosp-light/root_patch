...
public class UsbSettings extends SettingsPreferenceFragment {
    ...
    private static final String KEY_MASS_STORAGE = "usb_sdcard";

    private static final String USB_PROP = "persist.sys.usb.config";
	...
	mSDCard = (CheckBoxPreference) root.findPreference(KEY_MASS_STORAGE);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
		...
		android.os.SystemProperties.set(USB_PROP,
                    mSDCard.isChecked() ? "mtp,adb" : "0");
            function = UsbManager.USB_FUNCTION_MTP;
        } else if (preference == mPtp && mPtp.isChecked()) {
		android.os.SystemProperties.set(USB_PROP,
                    mSDCard.isChecked() ? "ptp,adb" : "0");
            function = UsbManager.USB_FUNCTION_PTP;
        } else if (preference == mSDCard && mSDCard.isChecked()) {
		android.os.SystemProperties.set(USB_PROP,
                    mSDCard.isChecked() ? "mass_storage,adb" : "0");
