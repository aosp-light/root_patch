...
import com.android.settings.extra.Addon;
...
public class PowerUsageSummary extends PreferenceFragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        String fastChargeState = Addon.readOneLine(FAST_CHARGE_FILE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_FAST_CHARGE:
                if (Addon.writeLine(FAST_CHARGE_FILE, item.isChecked() ? "0" : "1")) {
